...
import com.creactism.quicktalk.App;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    /** 错误日志文件名 */
    private final String LOGFILE_NAME = FileUtil.getCacheDir() + "crash.txt";

    public CrashHandler(App myApp){
     ...
     * @param context
     */
    private void collectVersionInfo(App context) {
        try {
    ...
    private void saveCrashInfoToFile(Throwable ex) {
        ...
        try {
            ...
            writer.write("创建时间：" + StringUtil.currentTime("yy-MM-dd hh:mm:ss").toString()+lineFeed+lineFeed);
