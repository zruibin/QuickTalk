...
//        this.setBackgroundColor(Color.parseColor("#333244"));
    ...
    public void onClick(View view) {
        ...
        if (tag instanceof Navigationbar.Action) {
            final Navigationbar.Action action = (Navigationbar.Action) tag;
            action.performAction(view);
        }
    }

    /**
     * Adds a list of {@link Navigationbar.Action}s.
     * @param actionList the actions to add
     */
    public void addActions(Navigationbar.ActionList actionList) {
    ...
    /**
     * Adds a new {@link Navigationbar.Action}.
     * @param action the action to add
     */
    public View addAction(Navigationbar.Action action) {
        final int index = mRightLayout.getChildCount();
        return addAction(action, index);
    }

    /**
     * Adds a new {@link Navigationbar.Action} at the specified index.
     * @param action the action to add
     * @param index the position at which to add the action
     */
    public View addAction(Navigationbar.Action action, int index) {
     ...
     */
    public void removeAction(Navigationbar.Action action) {
        int childCount = mRightLayout.getChildCount();
        for (int i = 0; i < childCount; i++) {
            View view = mRightLayout.getChildAt(i);
            if (view != null) {
                final Object tag = view.getTag();
                if (tag instanceof Navigationbar.Action && tag.equals(action)) {
    ...
    /**
     * Inflates a {@link View} with the given {@link Navigationbar.Action}.
     * @param action the action to inflate
     * @return a view
     */
    private View inflateAction(Navigationbar.Action action) {
        View view = null;
    ...
    public View getViewByAction(Navigationbar.Action action) {
    ...
    /**
     * A {@link LinkedList} that holds a list of {@link Navigationbar.Action}s.
     */
    @SuppressWarnings("serial")
    public static class ActionList extends LinkedList<Navigationbar.Action> {
    }
    ...
    public static abstract class ImageAction implements Navigationbar.Action {
    ...
    public static abstract class TextAction implements Navigationbar.Action {
