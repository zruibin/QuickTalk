...
#import "CRAStringPickerView.h"

@interface CRAStringPickerView () <UIPickerViewDelegate,UIPickerViewDataSource>
...
@property(nonatomic, copy) CRAStringResultBlock resultBlock;
// 单列选中的项
...
@implementation CRAStringPickerView
                      ...
                      resultBlock:(CRAStringResultBlock)resultBlock
{
    ...
    CRAStringPickerView *strPickerView = [[CRAStringPickerView alloc]initWithTitle:title dataSource:dataSource defaultSelValue:defaultSelValue isAutoSelect:isAutoSelect resultBlock:resultBlock];
