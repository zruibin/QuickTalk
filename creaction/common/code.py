...
CODE_ERROR_UNSUPPORTED_IMAGE_TYPE = 10012 #不支持的图片类型，仅仅支持JPG、GIF、PNG
CODE_ERROR_IMAGE_TOO_LARGE = 10013 # 图片太大
CODE_ERROR_DOSE_MULTIPART_HAS_IMAGE = 10014 # 请确保使用multpart上传图片
CODE_ERROR_CONTENT_IS_NULL = 10015 # 内容为空
CODE_ERROR_TEXT_TOO_LONG = 10016 # 输入文字太长，请确认不超过XXX个字符
CODE_ERROR_OUT_OF_LIMIT = 10017 # 发布内容过于频繁
CODE_ERROR_CONTAIN_ILLEGAL_WEBSITE = 10018 # 包含非法网址
CODE_ERROR_CONTAIN_ADVERTISING = 10019 # 包含非法内容
CODE_ERROR_TEST_AND_VERIFY = 10020 # 需要验证码
CODE_ERROR_SUCCESS_BUT_NEED_WAIT = 10021 # 发布成功，目前服务器可能会有延迟，请耐心等待1-2分钟
CODE_ERROR_ILLEGAL_COMMENT = 10022 # 不合法的评论
CODE_ERROR_ILLEGAL_JOURNAL = 10023 # 不合法的日志
CODE_ERROR_ILLEGAL_NICKNAME = 10024 # 不合法的昵称
CODE_ERROR_THE_PHONE_HAS_BE_USED = 10025 # 该手机号已经被使用
CODE_ERROR_THE_ACCOUNT_HAS_BEAN_BIND_PHONE = 10026 # 该用户已经绑定手机
CODE_ERROR_WRONG_VERIFIER = 10027 # Verifier错误
CODE_ERROR_AUTH_FAILD = 10028 # 认证失败
CODE_ERROR_PHONE_OR_PASSWORD_ERROR = 10029 # 手机或密码错误
CODE_ERROR_EMAIL_OR_PASSWORD_ERROR = 10030 # 邮箱或密码错误
CODE_ERROR_TOKEN_USED = 10031 # Token已经被使用
CODE_ERROR_TOKEN_EXPIRED = 10032 # Token已经过期
CODE_ERROR_TOKEN_REVOKED = 10033 # Token不合法
CODE_ERROR_CONTAINS_FORBID_WORLD = 10034 # 含有敏感词
CODE_ERROR_VERSION_REJECTED = 10035 # 版本号错误
...
MESSAGE = {
    ...
    CODE_ERROR_UNSUPPORTED_IMAGE_TYPE : "不支持的图片类型，仅仅支持JPG、GIF、PNG",
    CODE_ERROR_IMAGE_TOO_LARGE : "图片太大",
    CODE_ERROR_DOSE_MULTIPART_HAS_IMAGE : "请确保使用multpart上传图片",
