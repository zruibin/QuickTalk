...
"""
Note: 有bug, 无host属性问题
    替换成http://sdk.open.api.igexin.com/apiex.htm
    第206行，第347行
"""
...
class IGeTui:
    ...
    def pushMessageToList(self, contentId, targets):
        ...
        return self.httpPostJson("http://sdk.open.api.igexin.com/apiex.htm", params, True)
    ...
    def getContentId(self, message, taskGroupName=None):
        ...
        # ret = self.httpPostJson(self.host, params)
        ret = self.httpPostJson("http://sdk.open.api.igexin.com/apiex.htm", params)
