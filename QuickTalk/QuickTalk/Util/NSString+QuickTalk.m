...
- (BOOL)isMobileNumberClassification
{
    ...
    /**
     ...
     11         * 134[0-8],135,136,137,138,139,150,151,157,158,159,182,184,187,188，1705
     12         */
    NSString * CM = @"^1(34[0-8]|(3[5-9]|5[017-9]|8[2478])\\d|705)\\d{7}$";
    /**
...
- (BOOL)isMobileNumber
{
     ...
     */
    NSString *mobileNoRegex = @"^1((3\\d|5[0-35-9]|8[024-9])\\d|70[059])\\d{7}$";//除4以外的所有个位整数，不能使用[^4,\\d]匹配，这里是否iOS Bug?
