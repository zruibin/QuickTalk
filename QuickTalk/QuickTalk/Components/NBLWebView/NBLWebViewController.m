...
@interface NBLWebViewController ()<WKNavigationDelegate, WKUIDelegate, UIGestureRecognizerDelegate>
...
- (void)dealloc
{
    ...
    DLog(@"NBLWebViewController dealloc...");
}
...
- (UIProgressView *)progressView
{
    if (!_progressView) {
        ...
        _progressView.tintColor = QuickTalk_MAIN_COLOR;
...
- (UIBarButtonItem *)backItem
{
    if (!_backItem) {
        ...
        [button setImage:[[UIImage imageNamed:@"back"] imageWithTintColor:[UIColor blackColor]] forState:UIControlStateNormal];
...
//    [self.webView.configuration.userContentController addScriptMessageHandler:weakSelf name:baseMessagehandler];
}
