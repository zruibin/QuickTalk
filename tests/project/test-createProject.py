...
def createProject():
    ...
    data = {"user_uuid": "f6e996f8-7d83-11e7-889b-8c8590135ddc",
        ...
        "detail":"shutil.copyfile( src, dst) 从源src复制到dst中去。'当然前提是目标'地址是具备可写权限。抛出的异常信息为",
        "result":"预期结果",
        "resultMedias":["预期结果多媒体1(多媒体异步提交，名称使用数字标识1.png)", "预期结果多媒体2", "预期结果多媒体3"],
        "tagList":["标签'1", "标签2", "标签3"],
        "planList":[
            {"startTime":"2017-03-12 12:11:12", "finishTime":"2017-03-25 12:11:44", "content":"之前讲到几'个常用的CALayer的子类"},
            {"startTime":"2017-04-13 15:11:12", "finishTime":"2017-10-24 17:17:42", "content":"那我们今天就'从一个比较酷炫的开始"}
        ],
